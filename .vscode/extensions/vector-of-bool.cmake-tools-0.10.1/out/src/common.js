...
class CommonCMakeToolsBase {
    ...
    debugTarget() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield vscode.commands.executeCommand('vscode.startDebug', real_config);
        });
    }
    prepareConfigure() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    build(target_ = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.executeCMakeCommand([
                ...
                new diagnostics_1.BuildParser(this.binaryDir, config_1.config.enableOutputParsers, this.activeGenerator) :
                new util.NullParser()));
